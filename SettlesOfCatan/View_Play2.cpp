...
View_Play2::View_Play2(SDL_Window& win, SDL_Renderer& ren)
: IView(win, ren)
{
...
View_Play2::~View_Play2(){
	Logger::getLog().log(Logger::DEBUG, "View_Play2 destructor()");
	delete fps_timer;
...
void View_Play2::on_start(SDL_Event& ev){
	fps_timer->start();
}

void View_Play2::on_switch(SDL_Event& ev){
	fps_timer->stop();
}

void View_Play2::on_close(SDL_Event& ev){
	fps_timer->stop();
}

void View_Play2::handle_keyboard_events(SDL_Event& ev){
	const Uint8 *keyboard = SDL_GetKeyboardState(NULL);
...
void View_Play2::handle_mouse_events(SDL_Event& ev){
	mouse.update();
...
void View_Play2::handle_user_events(SDL_Event& ev){
...
void View_Play2::update(SDL_Event& ev){
	// do something for every user event
}


void View_Play2::render(){
	SDL_RenderClear(&ren);
	//render_graph();
	book.render(ren);
